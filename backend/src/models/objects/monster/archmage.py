...
class Archmage(Monster):
    ...
    loot_table: LootTable = LootTable(
        items=[
            ...
            LootTableItem(item_id="exalted_orb", chance=1, amount=1, random_amount=3),
            LootTableItem(item_id="annulment_orb", chance=1, amount=1, random_amount=3),
            LootTableItem(item_id="celestial_orb", chance=1, amount=1, random_amount=3),
        ]
    )
